    ...
    <div className="min-h-screen pt-24 pb-12 px-6">
      <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-left md:text-right w-full md:w-auto bg-surface-hover/30 p-4 rounded-xl border border-border">
            ...
            {user?.role === 'Administrator' ? (
              <div className="flex items-center md:justify-end gap-2 mb-3">
                ...
                {project.current_stage === 1 && project.stage_1_status !== 'Advance Paid' && project.stage_1_status !== 'Admin Approved' ? (
                  ...
                  <select 
                    className="bg-surface border border-border rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-growbroo-500 text-growbroo-400"
            ...
            {project.final_domain ? (
              ...
              <div className="flex items-center md:justify-end gap-2 mt-3 pt-3 border-t border-border">
                ...
                <a href={project.live_link} target="_blank" rel="noreferrer" className="text-sm text-growbroo-400 hover:underline flex items-center gap-1 bg-growbroo-500/10 px-2 py-1 rounded">
                  View App ↗
                </a>
              </div>
            ) : (
        ...
        {project.current_stage >= 1 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="text-growbroo-500">Project Brief (Stage 1)</CardTitle>
        ...
        {project.current_stage === 2 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader className="flex flex-row justify-between items-center">
              <CardTitle className="text-growbroo-500">Stage 2: Sample Version</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        {project.current_stage >= 4 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader><CardTitle className="text-growbroo-500">Stage 4: Final Approval</CardTitle></CardHeader>
            <CardContent>
        ...
        {project.current_stage >= 5 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader><CardTitle className="text-growbroo-500">Stage 5: Payment</CardTitle></CardHeader>
            <CardContent>
              {project.current_stage === 5 ? (
                <>
                  ...
                  {project.payment_company_name && (
                    <div className="mb-4 p-4 bg-surface-hover/30 border border-border rounded-lg">
                      ...
                      <p className="font-bold text-growbroo-500">{project.payment_company_name}</p>
                    </div>
                  )}
        ...
        {project.current_stage >= 6 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader><CardTitle className="text-growbroo-500">Stage 6: Domain & Hosting</CardTitle></CardHeader>
            <CardContent>
        ...
        {project.current_stage >= 7 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader><CardTitle className="text-growbroo-500">Stage 7: Website Live & Handoff</CardTitle></CardHeader>
            <CardContent>
              ...
              {user?.role === 'Growth Partner' && project.current_stage === 7 && (
                <div className="p-6 border border-border rounded-lg bg-surface-hover/20 mt-4">
                  ...
                  <Button variant="premium" className="bg-growbroo-500 w-full md:w-auto" onClick={gpMarkClientHappy}>
        ...
        {project.current_stage >= 8 && (
          <Card className="mb-8 border-growbroo-500/50">
            <CardHeader><CardTitle className="text-growbroo-500">Stage 8: Official Closure</CardTitle></CardHeader>
            <CardContent>
              ...
              {project.current_stage >= 9 && (
                <div className="mt-4 p-6 bg-gradient-to-r from-growbroo-500/20 to-green-500/20 border border-growbroo-500/50 rounded-xl text-center">
                  ...
                  {user?.role === 'Growth Partner' && (
                    <div className="pt-6 border-t border-white/10">
                      ...
                      <Button variant="outline" className="border-growbroo-500 text-growbroo-500 hover:bg-growbroo-500 hover:text-white" onClick={requestMaintenance}>
