    ...
    <div className="min-h-screen pt-24 pb-12 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Action Required */}
          <div>
            <h2 className="text-xl font-bold mb-6 text-bluetick-400 border-b border-border pb-2">
            ...
            {stage2Projects.length === 0 ? (
              ...
              <div className="space-y-4 mb-8">
                {stage2Projects.map(project => (
                  <Card 
                    key={project.id} 
                    className="border-bluetick-500 hover:border-bluetick-400 cursor-pointer transition-colors"
                    onClick={() => navigate(`/project/${project.id}`)}
                  >
                    <CardHeader className="bg-bluetick-500/5">
